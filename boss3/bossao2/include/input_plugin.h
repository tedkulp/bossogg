...
typedef gchar *(*input_play_chunk_f)(song_s *song, gint *size, gint64 *sample_num);
...
typedef struct input_plugin_t {
   ...
   input_samples_total_f input_samples_total;
...
gchar *input_play_chunk (gint *size, gint64 *sample_num);
